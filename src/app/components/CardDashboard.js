...
export default function CardDashboard({ entry }) {
    ...
    return (
      <div className="mt-5 mb-3 rounded-lg px-5 py-4 bg-gray-100 border border-transparent transition-colors hover:border-gray-300">
        <div className="lg:text-2xl sm:text-lg">
          <h2 className="lg:text-3xl sm:text-xl font-bold">My {entry?.title ||""}</h2>
          <p className="mt-2 lg:text-xl sm:text-md">{entry?.description || ""}</p>
